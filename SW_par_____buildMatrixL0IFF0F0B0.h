#ifndef __SW_PAR_____BUILDMATRIXL0IFF0F0B0_H
#define __SW_PAR_____BUILDMATRIXL0IFF0F0B0_H
...
class SW_par_____buildMatrixL0IFF0F0B0 : public ::x10::compiler::ws::RegularFrame
  {
    public:
    RTT_H_DECLS_CLASS
    ...
    static ::SW_par_____buildMatrixL0IFF0F0B0* _make(::x10::compiler::ws::Frame* up,
                                                     ::x10::compiler::ws::FinishFrame* ff)
    {
        ::SW_par_____buildMatrixL0IFF0F0B0* this_ = new (::x10aux::alloc_z< ::SW_par_____buildMatrixL0IFF0F0B0>()) ::SW_par_____buildMatrixL0IFF0F0B0();
        this_->_constructor(up, ff);
        return this_;
    }
    
    void _constructor(x10_int x, ::SW_par_____buildMatrixL0IFF0F0B0* o);
    
    static ::SW_par_____buildMatrixL0IFF0F0B0* _make(x10_int x,
                                                     ::SW_par_____buildMatrixL0IFF0F0B0* o);
...
#endif // SW_PAR_____BUILDMATRIXL0IFF0F0B0_H

class SW_par_____buildMatrixL0IFF0F0B0;

#ifndef SW_PAR_____BUILDMATRIXL0IFF0F0B0_H_NODEPS
#define SW_PAR_____BUILDMATRIXL0IFF0F0B0_H_NODEPS
#include <x10/compiler/ws/RegularFrame.h>
#include <x10/lang/Int.h>
#include <x10/lang/Long.h>
...
#ifndef SW_PAR_____BUILDMATRIXL0IFF0F0B0_H_GENERICS
#define SW_PAR_____BUILDMATRIXL0IFF0F0B0_H_GENERICS
#endif // SW_PAR_____BUILDMATRIXL0IFF0F0B0_H_GENERICS
#endif // __SW_PAR_____BUILDMATRIXL0IFF0F0B0_H_NODEPS
